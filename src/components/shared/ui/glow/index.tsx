import React, { type ReactNode, useEffect, useState, useRef, memo } from "react";
import {
  View,
...
export const Glow: React.FC<GlowProps> = memo<GlowProps>(
  ({
    children,
    size = 4,
    color = "#8b5cf6",
    ...
    const gradientIdRef = useRef(`glow-gradient-${Math.random().toString(36).slice(2, 8)}`);
